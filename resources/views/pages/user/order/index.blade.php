    ...
    <table class="table table-head-fixed text-nowrap table-striped " id="myTable" >
      ...
      @endphp
        ...
        <tr>
          ...
          @php
          $grandTotal += $user->price * $user->quantity;
          @endphp
          <td class="align-middle">
            {{-- update modal --}}
            {{-- <button type="button" data-id="{{ $user->id }}" class="btn editbtn btn-info"> <i class="fas fa-edit"></i>Edit </button> --}}
            <form action="/user/orders/{{$user ->id }}" method="POST" enctype="multipart/form-data" style="display: inline;" >
                @csrf
                @method('PUT')
                <input type="text" style="display: none;" value="1" name="is_deleted" id="is_deleted">
                <button onclick="return confirm('Are you sure you want to delete this item?')" type="submit"  class="btn  btn-danger" style="display:inline;"><i class="fa fa-trash"> </i>Delete</button>
            </form>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                          <form action="/admin/kitchen/{{$user ->id }}" method="POST" enctype="multipart/form-data"  id="formid">
                          @csrf
                          @method('PUT')
                          ...
                          <div class="row">
                            <div class="col-sm">
                              ...
                              <textarea name="address2" id="address2" cols="30" rows="2" class="form-control mb-1"  required></textarea>
                            </div>
                         </div>
                         ...
                         <div class="row">
                          <div class="col-sm">
                             ...
                             <input class="form-control mb-1" type="number" name="mobile2" id="mobile2" placeholder="Contact No." required>
                          </div>
                       </div>
                       ...
                       <div class="row">
                        <div class="col-sm">
                           ...
                           <input class="form-control mb-1" type="date" name="birthdate2" id="birthdate2"  required>
                        </div>
                     </div>
                     ...
                     <div class="row">
                      <div class="col-sm">
                         ...
                         <select class="form-control" aria-label="Default select example" name="gender2" id="gender2" required>
                   ...
                   <div class="row">
                    <div class="col-sm">
                       ...
                       <input class="form-control mb-1" type="email" name="email2" id="email2" placeholder="Email"  required>
                    </div>
                 </div>
                 ...
                 <div class="row">
                  <div class="col-sm">
                     ...
                     <input class="form-control mb-1" type="username" name="username2" id="username2" placeholder="Username"  required>
                  </div>
               </div>
               ...
               <div class="row">
                <div class="col-sm">
                   ...
                   <input class="form-control mb-1" type="password" name="password2" id="password2" placeholder="Password"  >
                </div>
             </div>
                        </div>
          </div>
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <form action="/user/place-order" method="POST" enctype="multipart/form-data">
                  @csrf
                 <div class="row">
                  <div class="col-sm">
    ...
    <div class="col-sm">
        ...
        <select class="form-control" aria-label="Default select example" name="address2" id="address2" required>
