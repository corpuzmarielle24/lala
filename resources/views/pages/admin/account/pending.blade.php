          ...
          <div class="col-12">
              ...
              <div class=" card-body table-responsive p-0" style="z-index: -99999">
                <table class="table table-head-fixed text-nowrap table-striped " id="myTable" >
                  ...
                  <td class="align-middle text-wrap" >
                    <form action="/admin/approval-account/{{$user ->id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                      @csrf
                      @method('PUT')
                      <input type="text" style="display: none;" value="1" name="status" id="status">
                      <button onclick="return confirm('Are you sure you want to approve this account?')" type="submit"  class="btn  btn-success m-1" style="display:inline;"><i class="fa fa-thumbs-up"> </i></button>
                  </form> 
                  <form action="/admin/approval-account/{{$user ->id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                    @csrf
                    @method('PUT')
                    <input type="text" style="display: none;" value="2" name="status" id="status">
                    <button onclick="return confirm('Are you sure you want to decline this account?')" type="submit"  class="btn  btn-danger m-1" style="display:inline;"><i class="fa fa-thumbs-down"> </i></button>
                </form> 
                  </td>
                    </tr>
                  @endforeach
