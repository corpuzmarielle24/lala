...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  <!-- Left navbar links -->
     <div class="row mx-0">
          ...
          <div class="col-sm-5">
            <h4 style="font-weight: bold" class="mt-1">Announcements</h4>
          </div>
                  ...
                  @endphp
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-wrap">
                        <a href="{{ asset('uploads/image/'.$user->image.'') }}" target="_blank">
                            <img src="{{ asset('uploads/image/'.$user->image.'') }}" style="height: 80px; width: 120px;" class="card-img-top" alt="...">
                        </a>
                    </td>

                      <td class="align-middle text-wrap" >{{$user ->title}}</td>
                      <td class="align-middle text-wrap" >{{$user ->description}}</td>

                      <td class="align-middle">
                        {{-- update modal --}}
                        <button type="button" data-id="{{ $user->id }}" class="btn editbtn btn-info"> <i class="fas fa-edit"></i>Edit </button>
                        <form action="/admin/announcement/{{$user ->id }}" method="POST" enctype="multipart/form-data" style="display: inline;" >
                            @csrf
                            @method('PUT')
                            <input type="text" style="display: none;" value="1" name="is_deleted" id="is_deleted">
                            <button onclick="return confirm('Are you sure you want to delete this announcement?')" type="submit"  class="btn  btn-danger" style="display:inline;"><i class="fa fa-trash"> </i>Delete</button>
                        </form>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                      <form action="/admin/announcement/{{$user ->id }}" method="POST" enctype="multipart/form-data"  id="formid">
                                      @csrf
                                      @method('PUT')
                                      ...
                                      <div class="container">
                                        <div class="row">
                                          <div class="col-sm">
                                             ...
                                             <input class="form-control mb-1" type="file" name="image" id="image" >
                                          </div>
                                       </div>
                                      ...
                                      <div class="row">
                                         <div class="col-sm">
                                            ...
                                            <input class="form-control mb-1" type="text" name="title" id="title2"2 placeholder="Title" required>
                                         </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col-sm">
                                          ...
                                          <textarea name="description" id="description2" cols="30" rows="2" class="form-control mb-1"  required></textarea>
                                        </div>
                                     </div>
...
{{--  --}}
       ...
       <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="addModalTitle">Announcement Information</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form method="POST" enctype="multipart/form-data" action="/admin/announcement">
                @csrf
                <div class="container">
                  <div class="row">
                    <div class="col-sm">
                ...
                <div class="row">
                   <div class="col-sm">
                      <label for="">Title</label>
                      <input class="form-control mb-1" type="text" name="title" id="title" placeholder="Title" required>
                   </div>
                </div>
...
console.log('asd');
          ...
          let updateroute = "/admin/announcement/"+data[0].toString();
