...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  ...
  <div class="row mx-0">
    ...
    <div class="col-sm-8">
      <h4 style="font-weight: bold" class="mt-1">Ready Orders
      </h4>
    </div>
  </div>
                    ...
                    <td class="align-middle text-wrap" >{{$user ->reference}}</td>
                      ...
                      <td class="align-middle text-wrap" >
                        ...
                        <form action="/staff/ready/{{$user ->id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                          ...
                          @method('PUT')
                          <button onclick="return confirm('Are you sure you want to set this status as on-the-way?')" type="submit"  class="btn  btn-primary" style="display:inline;"><i class=" fas fa-truck"> </i> On-The-Way</button>
                      </form> 
                      </td>
