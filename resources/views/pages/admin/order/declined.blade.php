...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  ...
  <div class="row mx-0">
    ...
    <div class="col-sm-8">
      <h4 style="font-weight: bold" class="mt-1">Declined Orders
      </h4>
    </div>
  </div>
                ...
                <table class="table table-head-fixed text-nowrap table-striped " id="myTable" >
                  ...
                  @endphp
                    ...
                    <td class="align-middle text-wrap" >{{$user ->reference}}</td>
                      ...
                      <td class="align-middle text-wrap" >
                        <a href="/staff/items/{{$user ->id}}">  <button  type="button"  class="btn  btn-info" style="display:inline;"><i class="fa fa-bars"> </i> View Items</button></a>
                      </td>
