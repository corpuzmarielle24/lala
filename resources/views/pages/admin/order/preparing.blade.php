...
<nav class="main-header  navbar-expand navbar-white navbar-light " style="padding: 5px !important;z-index: 1">
  ...
  <div class="row mx-0">
    ...
    <div class="col-sm-8">
      <h4 style="font-weight: bold" class="mt-1">Preparing Orders
      </h4>
    </div>
  </div>
                  ...
                  @endphp
                    ...
                    <td class="align-middle text-wrap" >{{$user ->reference}}</td>
                      ...
                      <td class="align-middle text-wrap" >
                        ...
                        <a href="/kitchen/items/{{$user ->id}}">  <button  type="button"  class="btn  btn-info  mb-2" style="display:inline;"><i class="fa fa-bars"> </i> View Items</button></a>
                        <form action="/kitchen/preparing/{{$user ->id }}" method="POST" enctype="multipart/form-data" style="display: inline;">
                          @csrf
                          <input type="hidden" name="status" value="Ready">
                          @method('PUT')
                          <button onclick="return confirm('Are you sure you want to set this status as ready?')" type="submit"  class="btn  btn-primary" style="display:inline;"><i class="fas fa-check-circle"> </i> Ready</button>
                      </form> 
                      </td>
